...
bool Adafruit_LIS3DH::begin(uint8_t i2caddr, uint8_t nWAI) {
  ...
  Adafruit_BusIO_Register _ctrl1 = Adafruit_BusIO_Register(i2c_dev, spi_dev, ADDRBIT8_HIGH_TOREAD, LIS3DH_REG_CTRL1, 1);
  _ctrl1.write(0x07); // enable all axes, normal mode

  // 400Hz rate
  setDataRate(LIS3DH_DATARATE_400_HZ);

  Adafruit_BusIO_Register _ctrl4 = Adafruit_BusIO_Register(i2c_dev, spi_dev, ADDRBIT8_HIGH_TOREAD, LIS3DH_REG_CTRL4, 1);
  ...
  Adafruit_BusIO_Register _tmp_cfg = Adafruit_BusIO_Register(i2c_dev, spi_dev, ADDRBIT8_HIGH_TOREAD, LIS3DH_REG_TEMPCFG, 1);
