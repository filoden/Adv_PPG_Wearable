 ...
 *   ODR3-0  Data rate selection. Default value: 00(0000:50 Hz; Others: Refer to Datasheet Table 26, “Data rate configuration”) 
 * LPen    Low power mode enable. Default value: 0 (0: normalmode, 1: low power mode) 
 * Zen     Z axis enable. Default value: 1 (0: Z axisdisabled; 1: Z axis enabled) 
 ...
 *   HPM1-0  High pass filter mode selection. Default value: 00 Refer to Table 29, "High pass filter mode configuration"
 ...
 *  HPIS2   X axis enable. Default value: 1 (0: X axis disabled; 1: X axis enabled) 
 ...
 * XL  X low. Default value: 0 (0: no interrupt, 1: X Low
 * event has occurred)
 *
 ...
 * XS  Enable interrupt single CLICK-CLICK on X axis. Default value:
